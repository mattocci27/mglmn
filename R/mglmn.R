#' mglmn: Model Averaging for Multivariate Generalized Linear Models and Multivariate Generalized Linear Latent Variable Models
#'
#' This package provide tools for univariate and multivariate GLM and multivariate GLLVM with model averaging and null model technique (Nakamura et al. 2015).
#'
#' \describe{
